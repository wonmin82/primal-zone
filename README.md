...
경량전술조끼는 강화조끼보다 방어가 낮지만 공격을 더하는 대안이다. 중량카빈·중장방호복은 현재도 부두에서 얻을 수 있는 고가의 장기 목표이며 첫 임무의 필수 준비물이 아니다. 새 지역이나 추가 임무를 요구하지 않는다. 적의 기존 드롭과 시체 배정 규칙을 보존하기 위해 이번 6종은 구매·교환 경로로 확장했다.
