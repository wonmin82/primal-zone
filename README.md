...
통신탑 복구 임무를 마치고 윤대장에게 보고하면 능선 북쪽에서 **깊은 밀림**으로 들어갈 수 있다. 밀림 입구의 선발대 길잡이에게 의뢰를 받고 관측소의 관측 표식과 수몰 도로의 수위 표식을 조사한다. 거목 군락의 신호 장치를 조사하면 연구구역 문이 열리고 포식자 둥지로 갈 수 있다. 보스를 처치한 뒤 길잡이에게 보고한다. 늪지 샛길에는 선택 보급품과 강한 사냥감이 있다.
